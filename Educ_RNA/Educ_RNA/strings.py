class Strings:
    ...
    class InstruccionesQuiz:
        quiz1 = '- El siguiente quiz tiene 5 preguntas, no hay tiempo límite ni nota.'
        quiz2 = '- Solo es para afianzar tu conocimiento.'
        quiz3 = '- Así que no te preocupes y escoge la opción que más te parezca.'
        quiz4 = '- Nosotros te indicaremos si fue correcta o no.'
